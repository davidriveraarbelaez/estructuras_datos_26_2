...
5. Colecciones y estructuras modernas
  ...
  5.2. Uso de librerías estándar
    5.2.1. vector, list, stack, queue
  5.3. Conjuntos (set, unordered_set)
  5.4. Mapas (map, unordered_map)
  5.5. Iteradores
  5.6. Comparadores y funciones de orden (functors/lambda)
   
6. Aplicaciones y persistencia
  6.1. Aplicaciones integradoras con estructuras de datos
  6.2. Manejo de archivos
  6.3. Uso de estructuras en problemas reales
